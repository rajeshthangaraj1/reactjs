...
/* Load meta tags */
  const meta = {
      title: lang.about_meta_title + lang.site_title_with_separator,
      description: lang.about_meta_title,
      meta: {
        name: {
          keywords: lang.about_meta_title
        }
      }
    };
class Aboutus extends React.Component {
  ...
  render() {
    ...
    return (
	   ...
	   <div className="container-fluid desktop-container"> <DocumentMeta  {...meta} />
            <div className="row">
                <div className="col-xs-12 main-title-bar">
                    ...
                    <h3 className="top-title main-title padding-right-20 text-uppercase">about us</h3>
                </div>
            </div>
            ...
            <div className="white-outer center-block">
                <div className="col-xs-10 div-center">
                    ...
                    <p className="text-left font-bold font-size-18">Our Mission</p><br/>
						...
						<br/><br/><br/>
						 <p className="text-left font-bold font-size-18">Why NinjaOS Exists?</p><br/>
