...
class Home extends React.Component {
  ...
  <a href="javascript:void(0)" className="closebtn"><img src="images/close-arrow.png"  alt=""/></a>
...
<div className="container">
 <ul id="filters" className="clearfix portfolio-sorting list-inline ">
			<li><span className="filter active" data-filter=".cars, .bikes, .mobiles, .laptops, .offers">Electronics</span></li>
			<li><span className="filter" data-filter=".cars">Cars</span></li>
			<li><span className="filter" data-filter=".bikes">Bikes</span></li>
			<li><span className="filter" data-filter=".mobiles">Mobiles</span></li>
			<li><span className="filter" data-filter=".laptops">Laptops</span></li>
			<li><span className="filter" data-filter=".offers">Offer Zone</span></li>
		</ul>
</div>
</div>
...
<div className="prdouct_wrapper_main">	
		   ...
		   <li className="portfolio cars" data-cat="cars"> 
...
<a className="link_btn" href="product.html">View all</a>
	...
	<ul className="products_list">
		...
		<div className="product_main">	
		 ...
		 <li className="portfolio bikes" data-cat="bikes"> 
		   <div className="top_header">
<h2>Bikes</h2>
<div className="pull-right btn_right">
<a className="link_btn" href="product.html">View all</a>
